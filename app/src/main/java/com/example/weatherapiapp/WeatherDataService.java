            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0; i< consolidated_weather_list.length();i++) {
                        ...
                        one_day_weather.setWeather_stat_abbr(first_day_from_api.getString("weather_state_abbr"));
                        one_day_weather.setWind_direction_compass(first_day_from_api.getString("created"));
